...
public class DepositUseCase {
    ...
    public DepositUseCase(WalletRepository walletRepository, TransactionRepository transactionRepository) {
    ...
    public WalletResponse execute(String userId, TransactionRequest request) {
        ...
        Transaction transaction = Transaction.createDeposit(wallet, amount, request.getDescription());
